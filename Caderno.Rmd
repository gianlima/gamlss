...
- Modelar variáveis resposta com distribuição de familia exponencial
...
***
#### 3. Modelo Generalizado Aditivo (GAM)
...
***
#### 4. Modelo Generalizado Aditivo Duplo
...
***
#### 6. Modelo Generalizado aditivo para locação, escala e forma.
